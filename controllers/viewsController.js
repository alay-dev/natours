...
exports.getTour = catchAsync(async (req, res, next) => {
  //1) Get the data, for the requested tour (including reviews nd guides)
...
exports.loginForm = catchAsync(async (req, res, next) => {
  res
    .status(200)
    .set('Content-Security-Policy', "Content-src 'self' http://127.0.0.1:3000/")
    .render('login', {
...
exports.udpateUserData = catchAsync(async (req, res, next) => {
