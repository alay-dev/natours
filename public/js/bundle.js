...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxheTAzMCIsImEiOiJja2t2YzJ3d3AxdmNyMm5xbnV4aDIzc3A3In0.rNeZMIltkr35gNmjNWYzYg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/alay030/ckkvcg8ph3was17n44dvuzhfm',
    scrollZoom: false
  });
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51IJgKpCGmpEwYTgV05FPbv7lvdQltQ4tkEtn9rt9z5Cr9nilZoxY3VRzR6hHj3bH37lXnPy0xMsyCfI5UKGMlbro00COjg9rBF'); //1)Get the session from the Server
          ...
          case 4:
            ...
            console.log(session); //2create checkout form + charge the credit card for us
